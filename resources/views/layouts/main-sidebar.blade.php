				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                            @can('unpaid_invoices')
							    <li><a class="slide-item" href="{{route('invoice_unpaid')}}">الفواتير الغير مدفوعه</a></li>
                            @endcan
                            @can('partial_invoices')
							    <li><a class="slide-item" href="{{route('invoice_partial')}}">الفواتير المدفوعه جزئيا</a></li>
                            @endcan
                            @can('invoices_archive')
                                <li><a class="slide-item" href="{{route('invoices_archive.index')}}">ارشفة الفواتير</a></li>
                            @endcan
						</ul>
					</li>
                    ...
                    @can('settings')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                @endcan
                                @can('contact_show')
                                <li><a class="slide-item" href="{{route('contacts.index')}}">معلومات التواصل</a></li>
                            @endcan
                            </ul>
                        </li>
                    @endcan
